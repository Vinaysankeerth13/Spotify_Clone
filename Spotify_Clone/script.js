...
const playMusic = (track, pause = false) => {
  // Check if track already includes file extension
...
async function main() {
  ...
  for (const song of songs) {
    ...
    if (typeof song !== "string") {
      formattedSong = song.toString();
    }
    formattedSong = formattedSong.replaceAll("%20", " ");
    formattedSong = formattedSong.replaceAll(".mp3", "");
    songUL.innerHTML =
      songUL.innerHTML +
      `<li>
  ...
  // Add eventlistener to opening the hamburger
  document.querySelector(".hamburger").addEventListener("click", () => {
    document.querySelector(".left").style.left = "0";
  });

  // Add eventlistener to closing the hamburger
...
//         const element = as[index];
//         if (element.href.endsWith(".mp3")) {
//             songs.push(element.href.split(`http://127.0.0.1:3000/Spotify_Clone/Songs/`)[1])
//         }
//     }
...
// const playMusic = (track, pause = false) => {
//     currentSong.src = `http://127.0.0.1:3000/Spotify_Clone/Songs/` + track
//     if (!pause) {
//         currentSong.play()
